        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Culture Assessment Surveys</h1>
                <p className="mt-1 text-sm text-gray-500">
                  Participate in organizational culture assessments
                </p>
              </div>
            </div>
          </div>
              ...
              <div key={survey.id} className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Status: <span className={`font-medium ${
                    survey.status === 'OPEN' ? 'text-green-600' : 
                    survey.status === 'DRAFT' ? 'text-yellow-600' : 'text-red-600'
                  }`}>
                    {survey.status}
                  </span>
                </p>
