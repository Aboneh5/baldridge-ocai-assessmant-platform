...
import { BarChart3, Mail, Lock, Key, AlertCircle, Loader2 } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link href="/" className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-indigo-600 font-medium">by Tenadam</p>
            </div>
          </Link>
        </div>
      </header>
            ...
            {mode === 'credentials' ? (
              ...
              <form onSubmit={handleAccessKeyLogin} className="space-y-6">
                <div>
                  ...
                  <div className="mt-1 relative">
                    <input
                      ...
                      className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm uppercase font-mono tracking-wider"
                ...
                <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                  <p className="text-xs font-semibold text-green-900 mb-2">Demo Access Keys:</p>
